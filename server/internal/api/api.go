...
func (api *Impl) PutV1Cart(c *gin.Context, params floralApi.PutV1CartParams) {
	api.PostV1Cart(c, floralApi.PostV1CartParams(params))
}
func (api *Impl) PatchV1Cart(c *gin.Context, params floralApi.PatchV1CartParams) {
	api.PostV1Cart(c, floralApi.PostV1CartParams(params))
}
