...
CREATE TABLE "floral"."product_common_traits" (
...
CREATE INDEX ON "floral"."product" ("store_id");

CREATE INDEX ON "floral"."user_favorite" ("user_id");

CREATE INDEX ON "floral"."user_favorite" ("product_id");

CREATE INDEX ON "floral"."cart_position" ("user_id");

CREATE INDEX ON "floral"."cart_position" ("product_id");

CREATE UNIQUE INDEX ON "floral"."cart_position" ("user_id", "product_id");

CREATE INDEX ON "floral"."order" ("user_id");

CREATE INDEX ON "floral"."order_position" ("order_id");

CREATE INDEX ON "floral"."order_position" ("product_id");

CREATE UNIQUE INDEX ON "floral"."order_position" ("product_id", "order_id");

CREATE INDEX ON "floral"."review" ("user_id");

CREATE INDEX ON "floral"."review" ("product_id");

CREATE UNIQUE INDEX ON "floral"."review" ("user_id", "product_id");
